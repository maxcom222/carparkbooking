...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoExtraCreateTitle', true), __('infoExtraCreateDesc', true));
	?>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminExtras&amp;action=pjActionCreate" method="post" id="frmCreateExtra" class="pj-form form">
		...
		<div class="clear_both">
			...
			<p>
				...
				<span class="inline_block">
					<span class="pj-form-field-custom pj-form-field-custom-before float_left r10">
						...
						<input type="text" id="price" name="price" class="pj-form-field required number w80"/>
					</span>
			...
			<p>
				...
				<span class="inline_block">
					<select name="type" class="pj-form-field w100">
						<?php
			...
			<p class="cpLimitedCount">
				<label class="title"><?php __('lblCount');?></label>
				<span class="inline_block">
					<input type="text" id="cnt" name="cnt" class="pj-form-field digits w80 field-int"/>
				</span>
			</p>
			<p>
				<label class="title"><?php __('lblIsSingle');?></label>
				<span class="inline_block">
					<label class="content"><input type="checkbox" name="is_single" id="is_single" value="1"/></label>
				</span>
			</p>
			<p>
